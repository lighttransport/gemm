...
"}\n"
"\n"
"/* ---- gemm_tiled_f32_f32: F32 weight GEMM for higher precision ---- */\n"
"/* Same tiling as f16_f32 but reads float weights directly */\n"
...
"}\n"
"\n"
"/* ---- resize_normalize: area-based downscale + ImageNet normalize ---- */\n"
"/* Matches cv2.INTER_AREA for downscaling (averaging source pixels in area) */\n"
...
"    int iy0 = (int)sy0f;\n"
"    int iy1 = (int)sy1f; if (iy1 >= src_h) iy1 = src_h - 1;\n"
"    int ix0 = (int)sx0f;\n"
"    int ix1 = (int)sx1f; if (ix1 >= src_w) ix1 = src_w - 1;\n"
...
"                float w = wy * wx;\n"
"                sum += (float)src[(iy * src_w + ix) * 3 + c] * w;\n"
"                wsum += w;\n"
"            }\n"
"        }\n"
...
"                         * img[ci * img_hw + (py*ps+kh) * img_w + (px*ps+kw)];\n"
"        out[tok * dim + co] = sum;\n"
"    }\n"
"}\n"
"\n"
