...
static const char hip_sam3d_body_kernels_src[] =
    ...
    /* ---- gemm_bf16w_bf16a_wmma_t: F32-weight x F32-act GEMM via BF16 WMMA
     * (gfx12) for the decoder (F32 weights). Transposed-B like gemm_f32_bias,
     * arg order {Y,W,X,bias,n_out,n_in,n_tok}. RNE bf16 both operands at SMEM
     * load. Requires n_out%16==0 && n_in%16==0; caller falls back to
     * gemm_f32_bias. */
    "#if defined(__gfx1200__) || defined(__gfx1201__)\n"
