/*
 * verify_kp_update (CUDA) — diff hip_sam3d_body_debug_run_kp_token_update
...
int main(int argc, char **argv)
{
    ...
    if (!img_emb) { hip_sam3d_body_destroy(ctx); return 4; }
    ...
    for (int li = lo; li < hi; li++) {
        ...
        int rc = hip_sam3d_body_debug_run_kp_token_update(
