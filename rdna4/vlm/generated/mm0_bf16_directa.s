...
; %bb.0:
	...
	v_dual_mov_b32 v121, 0 :: v_dual_lshlrev_b32 v148, 4, v0
	v_or_b32_e32 v1, s12, v0
	v_lshlrev_b32_e32 v3, 1, v0
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_3)
	v_dual_mov_b32 v122, v121 :: v_dual_and_b32 v147, 15, v0
	v_mov_b32_e32 v124, v121
	s_lshl_b32 s1, ttmp7, 7
	v_dual_mov_b32 v6, v121 :: v_dual_and_b32 v149, 64, v3
	v_lshrrev_b32_e32 v8, 1, v0
	v_dual_mov_b32 v3, v121 :: v_dual_and_b32 v162, 16, v0
	v_mov_b32_e32 v123, v121
	s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
	v_or3_b32 v153, s1, v149, v147
	v_and_b32_e32 v150, 8, v8
	v_dual_mov_b32 v126, v121 :: v_dual_and_b32 v151, 0x4f, v0
	s_wait_kmcnt 0x0
	v_mad_co_i64_i32 v[145:146], null, 0x2400, v1, s[6:7]
	v_or_b32_e32 v8, 48, v153
	v_or_b32_e32 v158, 32, v153
	v_mad_co_i64_i32 v[154:155], null, 0x2400, v153, 0
	v_lshlrev_b32_e32 v163, 4, v150
	s_delay_alu instid0(VALU_DEP_4)
	v_mad_co_i64_i32 v[156:157], null, 0x2400, v8, 0
	s_clause 0x3
	global_load_b128 v[129:132], v[145:146], off
	global_load_b128 v[133:136], v[145:146], off offset:16
	global_load_b128 v[137:140], v[145:146], off offset:32
	global_load_b128 v[141:144], v[145:146], off offset:48
	v_or_b32_e32 v8, 16, v153
	v_mad_co_i64_i32 v[158:159], null, 0x2400, v158, 0
	v_or_b32_e32 v154, v154, v162
	v_lshlrev_b32_e32 v153, 4, v163
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_1) | instid1(VALU_DEP_4)
	v_mad_co_i64_i32 v[160:161], null, 0x2400, v8, 0
	v_or_b32_e32 v8, v156, v162
	v_add_co_u32 v154, vcc_lo, s8, v154
	v_or_b32_e32 v156, v158, v162
	v_add_co_ci_u32_e64 v155, null, s9, v155, vcc_lo
	v_or_b32_e32 v158, v160, v162
	v_add_co_u32 v8, vcc_lo, s8, v8
	s_wait_alu 0xfffd
	v_add_co_ci_u32_e64 v160, null, s9, v157, vcc_lo
	v_add_co_u32 v162, vcc_lo, s8, v156
	s_wait_alu 0xfffd
	v_add_co_ci_u32_e64 v163, null, s9, v159, vcc_lo
	v_add_co_u32 v156, vcc_lo, s8, v158
	s_wait_alu 0xfffd
	v_add_co_ci_u32_e64 v157, null, s9, v161, vcc_lo
	v_add_co_u32 v158, vcc_lo, v8, 32
	s_wait_alu 0xfffd
	v_add_co_ci_u32_e64 v159, null, 0, v160, vcc_lo
	v_add_co_u32 v160, vcc_lo, v162, 32
	v_dual_mov_b32 v125, v121 :: v_dual_mov_b32 v128, v121
	v_dual_mov_b32 v127, v121 :: v_dual_mov_b32 v114, v121
	v_dual_mov_b32 v113, v121 :: v_dual_mov_b32 v116, v121
	v_dual_mov_b32 v115, v121 :: v_dual_mov_b32 v118, v121
	v_dual_mov_b32 v117, v121 :: v_dual_mov_b32 v120, v121
	v_dual_mov_b32 v119, v121 :: v_dual_mov_b32 v106, v121
	v_dual_mov_b32 v105, v121 :: v_dual_mov_b32 v108, v121
	v_dual_mov_b32 v107, v121 :: v_dual_mov_b32 v110, v121
	v_dual_mov_b32 v109, v121 :: v_dual_mov_b32 v112, v121
	v_dual_mov_b32 v111, v121 :: v_dual_mov_b32 v98, v121
	v_dual_mov_b32 v97, v121 :: v_dual_mov_b32 v100, v121
	v_dual_mov_b32 v99, v121 :: v_dual_mov_b32 v102, v121
	v_dual_mov_b32 v101, v121 :: v_dual_mov_b32 v104, v121
	v_dual_mov_b32 v103, v121 :: v_dual_mov_b32 v90, v121
	v_dual_mov_b32 v89, v121 :: v_dual_mov_b32 v92, v121
	v_dual_mov_b32 v91, v121 :: v_dual_mov_b32 v94, v121
	v_dual_mov_b32 v93, v121 :: v_dual_mov_b32 v96, v121
	v_dual_mov_b32 v95, v121 :: v_dual_mov_b32 v82, v121
	v_dual_mov_b32 v81, v121 :: v_dual_mov_b32 v84, v121
	v_dual_mov_b32 v83, v121 :: v_dual_mov_b32 v86, v121
	v_dual_mov_b32 v85, v121 :: v_dual_mov_b32 v88, v121
	v_dual_mov_b32 v87, v121 :: v_dual_mov_b32 v74, v121
	v_dual_mov_b32 v73, v121 :: v_dual_mov_b32 v76, v121
	v_dual_mov_b32 v75, v121 :: v_dual_mov_b32 v78, v121
	v_dual_mov_b32 v77, v121 :: v_dual_mov_b32 v80, v121
	v_dual_mov_b32 v79, v121 :: v_dual_mov_b32 v66, v121
	v_dual_mov_b32 v65, v121 :: v_dual_mov_b32 v68, v121
	v_dual_mov_b32 v67, v121 :: v_dual_mov_b32 v70, v121
	v_dual_mov_b32 v69, v121 :: v_dual_mov_b32 v72, v121
	v_dual_mov_b32 v71, v121 :: v_dual_mov_b32 v58, v121
	v_dual_mov_b32 v57, v121 :: v_dual_mov_b32 v60, v121
	v_dual_mov_b32 v59, v121 :: v_dual_mov_b32 v62, v121
	v_dual_mov_b32 v61, v121 :: v_dual_mov_b32 v64, v121
	v_dual_mov_b32 v63, v121 :: v_dual_mov_b32 v50, v121
	v_dual_mov_b32 v49, v121 :: v_dual_mov_b32 v52, v121
	v_dual_mov_b32 v51, v121 :: v_dual_mov_b32 v54, v121
	v_dual_mov_b32 v53, v121 :: v_dual_mov_b32 v56, v121
	v_dual_mov_b32 v55, v121 :: v_dual_mov_b32 v42, v121
	v_dual_mov_b32 v41, v121 :: v_dual_mov_b32 v44, v121
	v_dual_mov_b32 v43, v121 :: v_dual_mov_b32 v46, v121
	v_dual_mov_b32 v45, v121 :: v_dual_mov_b32 v48, v121
	v_dual_mov_b32 v47, v121 :: v_dual_mov_b32 v34, v121
	v_dual_mov_b32 v33, v121 :: v_dual_mov_b32 v36, v121
	v_dual_mov_b32 v35, v121 :: v_dual_mov_b32 v38, v121
	v_dual_mov_b32 v37, v121 :: v_dual_mov_b32 v40, v121
	v_dual_mov_b32 v39, v121 :: v_dual_mov_b32 v26, v121
	v_dual_mov_b32 v25, v121 :: v_dual_mov_b32 v28, v121
	v_dual_mov_b32 v27, v121 :: v_dual_mov_b32 v30, v121
	v_dual_mov_b32 v29, v121 :: v_dual_mov_b32 v32, v121
	v_dual_mov_b32 v31, v121 :: v_dual_mov_b32 v18, v121
	v_dual_mov_b32 v17, v121 :: v_dual_mov_b32 v20, v121
	v_dual_mov_b32 v19, v121 :: v_dual_mov_b32 v22, v121
	v_dual_mov_b32 v21, v121 :: v_dual_mov_b32 v24, v121
	v_dual_mov_b32 v23, v121 :: v_dual_mov_b32 v10, v121
	v_dual_mov_b32 v9, v121 :: v_dual_mov_b32 v12, v121
	v_dual_mov_b32 v11, v121 :: v_dual_mov_b32 v14, v121
	v_dual_mov_b32 v13, v121 :: v_dual_mov_b32 v16, v121
	v_dual_mov_b32 v15, v121 :: v_dual_mov_b32 v2, v121
	v_dual_mov_b32 v1, v121 :: v_dual_mov_b32 v4, v121
	v_dual_mov_b32 v5, v121 :: v_dual_mov_b32 v8, v121
	v_mov_b32_e32 v7, v121
	v_lshlrev_b32_e32 v151, 4, v151
	v_or_b32_e32 v152, 0x300, v148
	s_wait_alu 0xfffd
	v_add_co_ci_u32_e64 v161, null, 0, v163, vcc_lo
	s_mov_b32 s6, 0
	s_mov_b64 s[2:3], 0
	s_mov_b32 s7, 0
	s_wait_loadcnt 0x3
	...
	s_wait_loadcnt 0x2
	ds_store_b128 v148, v[133:136] offset:2048
	s_wait_loadcnt 0x1
	ds_store_b128 v148, v[137:140] offset:4096
	s_wait_loadcnt 0x0
	ds_store_b128 v148, v[141:144] offset:6144
	;;#ASMSTART
	s_barrier_signal -1
	;;#ASMEND
	;;#ASMSTART
...
; %bb.3:                                ;   in Loop: Header=BB0_2 Depth=1
	v_add_co_u32 v129, vcc_lo, v145, s2
	s_wait_alu 0xfffd
	v_add_co_ci_u32_e64 v130, null, s3, v146, vcc_lo
	s_clause 0x3
	global_load_b128 v[141:144], v[129:130], off offset:64
	global_load_b128 v[137:140], v[129:130], off offset:80
	global_load_b128 v[133:136], v[129:130], off offset:96
	global_load_b128 v[129:132], v[129:130], off offset:112
.LBB0_4:                                ;   in Loop: Header=BB0_2 Depth=1
	v_add_co_u32 v194, vcc_lo, v154, s2
	s_wait_alu 0xfffd
	v_add_co_ci_u32_e64 v195, null, s3, v155, vcc_lo
	v_add_co_u32 v196, vcc_lo, v156, s2
	s_wait_alu 0xfffd
	v_add_co_ci_u32_e64 v197, null, s3, v157, vcc_lo
	global_load_b128 v[162:165], v[194:195], off
	v_lshl_or_b32 v174, s6, 13, v153
	v_add_co_u32 v198, vcc_lo, v160, s2
	global_load_b128 v[166:169], v[196:197], off
	v_add_co_u32 v200, s0, v158, s2
	s_wait_alu 0xfffd
	v_add_co_ci_u32_e64 v199, null, s3, v161, vcc_lo
	s_wait_alu 0xf1ff
	v_add_co_ci_u32_e64 v201, null, s3, v159, s0
	v_add_nc_u32_e32 v202, v151, v174
	v_add_nc_u32_e32 v203, v152, v174
	s_clause 0x1
	global_load_b128 v[170:173], v[198:199], off offset:-32
	global_load_b128 v[174:177], v[200:201], off offset:-32
	ds_load_b128 v[178:181], v202
	ds_load_b128 v[182:185], v202 offset:256
	ds_load_b128 v[186:189], v202 offset:512
	ds_load_b128 v[190:193], v203
	s_wait_alu 0xfffe
	s_and_not1_b32 vcc_lo, exec_lo, s8
	s_mov_b32 s0, -1
	s_wait_loadcnt_dscnt 0x303
	v_wmma_f32_16x16x16_bf16 v[121:128], v[162:165], v[178:181], v[121:128]
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x16_bf16 v[113:120], v[162:165], v[182:185], v[113:120]
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x16_bf16 v[105:112], v[162:165], v[186:189], v[105:112]
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x16_bf16 v[97:104], v[162:165], v[190:193], v[97:104]
	s_clause 0x1
	global_load_b128 v[162:165], v[194:195], off offset:32
	global_load_b128 v[194:197], v[196:197], off offset:32
	s_wait_loadcnt 0x4
	v_wmma_f32_16x16x16_bf16 v[89:96], v[166:169], v[178:181], v[89:96]
	v_wmma_f32_16x16x16_bf16 v[81:88], v[166:169], v[182:185], v[81:88]
	v_wmma_f32_16x16x16_bf16 v[73:80], v[166:169], v[186:189], v[73:80]
	v_wmma_f32_16x16x16_bf16 v[65:72], v[166:169], v[190:193], v[65:72]
	s_clause 0x1
	global_load_b128 v[166:169], v[198:199], off
	global_load_b128 v[198:201], v[200:201], off
	s_wait_loadcnt 0x5
	v_wmma_f32_16x16x16_bf16 v[57:64], v[170:173], v[178:181], v[57:64]
	v_wmma_f32_16x16x16_bf16 v[49:56], v[170:173], v[182:185], v[49:56]
	v_wmma_f32_16x16x16_bf16 v[41:48], v[170:173], v[186:189], v[41:48]
	v_wmma_f32_16x16x16_bf16 v[33:40], v[170:173], v[190:193], v[33:40]
	ds_load_b128 v[170:173], v202 offset:4096
	s_wait_loadcnt 0x4
	v_wmma_f32_16x16x16_bf16 v[25:32], v[174:177], v[178:181], v[25:32]
	ds_load_b128 v[178:181], v202 offset:4352
	v_wmma_f32_16x16x16_bf16 v[17:24], v[174:177], v[182:185], v[17:24]
	ds_load_b128 v[182:185], v202 offset:4608
	v_wmma_f32_16x16x16_bf16 v[9:16], v[174:177], v[186:189], v[9:16]
	ds_load_b128 v[186:189], v203 offset:4096
	v_wmma_f32_16x16x16_bf16 v[1:8], v[174:177], v[190:193], v[1:8]
	s_wait_loadcnt_dscnt 0x303
	v_wmma_f32_16x16x16_bf16 v[121:128], v[162:165], v[170:173], v[121:128]
	s_wait_dscnt 0x2
	v_wmma_f32_16x16x16_bf16 v[113:120], v[162:165], v[178:181], v[113:120]
	s_wait_dscnt 0x1
	v_wmma_f32_16x16x16_bf16 v[105:112], v[162:165], v[182:185], v[105:112]
	s_wait_dscnt 0x0
	v_wmma_f32_16x16x16_bf16 v[97:104], v[162:165], v[186:189], v[97:104]
	s_wait_loadcnt 0x2
	v_wmma_f32_16x16x16_bf16 v[89:96], v[194:197], v[170:173], v[89:96]
	v_wmma_f32_16x16x16_bf16 v[81:88], v[194:197], v[178:181], v[81:88]
	v_wmma_f32_16x16x16_bf16 v[73:80], v[194:197], v[182:185], v[73:80]
	v_wmma_f32_16x16x16_bf16 v[65:72], v[194:197], v[186:189], v[65:72]
	s_wait_loadcnt 0x1
	v_wmma_f32_16x16x16_bf16 v[57:64], v[166:169], v[170:173], v[57:64]
	v_wmma_f32_16x16x16_bf16 v[49:56], v[166:169], v[178:181], v[49:56]
	v_wmma_f32_16x16x16_bf16 v[41:48], v[166:169], v[182:185], v[41:48]
	v_wmma_f32_16x16x16_bf16 v[33:40], v[166:169], v[186:189], v[33:40]
	s_wait_loadcnt 0x0
	v_wmma_f32_16x16x16_bf16 v[25:32], v[198:201], v[170:173], v[25:32]
	v_wmma_f32_16x16x16_bf16 v[17:24], v[198:201], v[178:181], v[17:24]
	v_wmma_f32_16x16x16_bf16 v[9:16], v[198:201], v[182:185], v[9:16]
	v_wmma_f32_16x16x16_bf16 v[1:8], v[198:201], v[186:189], v[1:8]
	s_wait_alu 0xfffe
...
; %bb.5:                                ;   in Loop: Header=BB0_2 Depth=1
	...
	s_wait_alu 0xfffe
	v_lshl_or_b32 v162, s6, 13, v148
	s_add_co_i32 s7, s7, 32
	s_mov_b32 s0, 0
	ds_store_b128 v162, v[141:144]
	ds_store_b128 v162, v[137:140] offset:2048
	ds_store_b128 v162, v[133:136] offset:4096
	ds_store_b128 v162, v[129:132] offset:6144
	;;#ASMSTART
	s_barrier_signal -1
	;;#ASMEND
	;;#ASMSTART
...
.Lfunc_end0:
	.size	gemm_mm0_bf16_asm, .Lfunc_end0-gemm_mm0_bf16_asm
                                        ; -- End function
	.set gemm_mm0_bf16_asm.num_vgpr, 204
	.set gemm_mm0_bf16_asm.num_agpr, 0
	.set gemm_mm0_bf16_asm.numbered_sgpr, 13
...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	...
	.text
	.type	__hip_cuid_e4bcb44ddaddf82c,@object ; @__hip_cuid_e4bcb44ddaddf82c
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_e4bcb44ddaddf82c
__hip_cuid_e4bcb44ddaddf82c:
	.byte	0                               ; 0x0
	.size	__hip_cuid_e4bcb44ddaddf82c, 1
	...
	.addrsig
	.addrsig_sym __hip_cuid_e4bcb44ddaddf82c
	.amdgpu_metadata
---
amdhsa.kernels:
  - .args:
