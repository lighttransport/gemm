...
int main(int argc, char **argv) {
    ...
    if (latent_dump_steps && *latent_dump_steps) {
        ...
        cuda_hy3d_set_latent_dump(r, latent_dump_steps, latent_dump_prefix);
    ...
    if (velocity_dump_steps && *velocity_dump_steps) {
        ...
        cuda_hy3d_set_velocity_dump(r, velocity_dump_steps, velocity_dump_prefix);
    ...
    if (init_latents_path) {
        ...
        if (cuda_hy3d_set_init_latents(r, lat, n_lat) != 0) {
    ...
    if (init_context_path) {
        ...
        if (cuda_hy3d_set_init_contexts(r, cond, uncond, n_ctx) != 0) {
