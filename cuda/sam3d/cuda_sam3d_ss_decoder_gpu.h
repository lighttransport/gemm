...
#ifndef CUDA_SAM3D_SS_DECODER_GPU_H_
#define CUDA_SAM3D_SS_DECODER_GPU_H_
...
typedef struct {
    CUdeviceptr gn1_w, gn1_b;
    CUdeviceptr conv1_w, conv1_b;
    CUdeviceptr gn2_w, gn2_b;
...
typedef struct {
    ...
    CUdeviceptr up1_conv_w, up1_conv_b;
    cs3d_ssdec_resblock_gpu res_32[2];
    CUdeviceptr up2_conv_w, up2_conv_b;
    cs3d_ssdec_resblock_gpu res_64[2];
    CUdeviceptr out_gn_w, out_gn_b;
    CUdeviceptr out_conv_w, out_conv_b;
    size_t total_bytes;
    int loaded;
} cs3d_ssdec_gpu;
...
#endif /* CUDA_SAM3D_SS_DECODER_GPU_H_ */

#ifdef CUDA_SAM3D_SS_DECODER_GPU_IMPLEMENTATION
...
#endif /* CUDA_SAM3D_SS_DECODER_GPU_IMPLEMENTATION */
