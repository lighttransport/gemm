...
"__global__ void gemm_fp8_scaled_f32_pipe(float *Y, const unsigned char *W, const float *X,\n"
"                                          const float *bias, int n_out, int n_in, int n_tok,\n"
"                                          float w_scale, const float *x_max_ptr) {\n"
...
"         * 128 threads × 8 floats = 1024 floats per pass. Each lane emits 2 ×\n"
"         * u32 of packed e4m3 (8 bytes). */\n"
"        int srow = tid / 4;\n"
"        int scol = (tid & 3) * 8;\n"
"        int grow = tok_base + srow;\n"
"        float xv[8];\n"
"#pragma unroll\n"
"        for (int j = 0; j < 8; j++) {\n"
"            float v = (grow < n_tok) ? X[(long)grow * n_in + k + scol + j] : 0.0f;\n"
"            xv[j] = v * x_inv_scale;\n"
"        }\n"
