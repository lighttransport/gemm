...
int main(int argc, char **argv)
{
    ...
    /* ---- blend_shape (45 basis) ---- */
    {
        ...
        if (r != 0) {
            ...
            r = cuda_sam3d_body_debug_run_blend_shape(ctx, coeffs, gpu_out);
            if (r != 0) {
    ...
    /* ---- face_expressions (72 basis) ---- */
    {
        ...
        if (r != 0) {
            ...
            r = cuda_sam3d_body_debug_run_face_expressions(ctx, coeffs, gpu_out);
            if (r != 0) {
    ...
    /* ---- pose_correctives (joint_params 127×7 → V*3) ---- */
    {
        ...
        if (r != 0) {
            ...
            r = cuda_sam3d_body_debug_run_pose_correctives(ctx, jp, gpu_out);
            if (r != 0) {
    ...
    /* ---- LBS skin_points (global_skel + rest_verts → V*3) ---- */
    {
        ...
        if (r != 0) {
            ...
            r = cuda_sam3d_body_debug_run_lbs_skin(ctx, global_skel, rverts, gpu_out);
            if (r != 0) {
