	// Same as dgemm.kernel.s but WITHOUT sector cache hints
	// dl_gmwn1_no_sector_ (&ma, &nb_th, &kk, a, pb, &ldb, pc, &ldc);
	.text
	.align	2
	.global	dl_gmwn1_no_sector_
	.type	dl_gmwn1_no_sector_, %function
dl_gmwn1_no_sector_:
	...
	// REMOVED: Sector cache hints
	// Original had:
	//   mov x22, 0x2; lsl x22, 56; orr x6, x6, x22  (Sector 1 for C)
	//   mov x22, 0x41; lsl x22, 56; orr x3, x3, x22 (Sector 0 + prefetch for A)
...
.L1_ns:
	...
	ret
	.size	dl_gmwn1_no_sector_, .-dl_gmwn1_no_sector_
