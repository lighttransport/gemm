...
echo "=== Final Best Configuration Search ==="
echo "Looking for >80% efficiency"
echo ""

fcc -O3 -Nclang -mcpu=a64fx+sve -c micro_kernel_6x4_sector_unroll3.S -o micro_kernel_6x4_sector_unroll3.o

cat > bench_final.c << 'EOF'
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <string.h>
...
fcc -O3 -Nclang -mcpu=a64fx+sve -fopenmp bench_final.c \
    micro_kernel_6x4_sector_unroll3.o \
    -o bench_final

echo "=== Best configurations from grid search (longer runs) ==="
echo ""

# Grid search identified these as best
./bench_final -m 78 -k 512 -i 300
./bench_final -m 90 -k 512 -i 300
./bench_final -m 72 -k 512 -i 300
./bench_final -m 84 -k 504 -i 300
./bench_final -m 66 -k 512 -i 300

echo ""
echo "=== Fine-grained M search around M=78 ==="
for M in 74 76 78 80 82; do
    ./bench_final -m $M -k 512 -i 300
done

echo ""
echo "=== Different N sizes ==="
./bench_final -m 78 -k 512 -n 4096 -i 300
./bench_final -m 78 -k 512 -n 16384 -i 300

echo ""
echo "=== Summary ==="
echo "Best kernel: micro_kernel_6x4_sector_unroll3"
echo "Peak theoretical: 2.0 SDOT/cycle (6144 GOPS at 2GHz)"
echo ""
echo "=== Done ==="
