...
#PJM -g hp250467
#PJM -L "rscgrp=small,node=256,elapse=01:10:00"
...
NP=256; JOB_TAG=${PJM_JOBID:-manual_$$}; WORK="$GLM5/tf256_run_${JOB_TAG}"
export GLM5_MODEL_DIR=${GLM5_MODEL_DIR:-$HOME/models/glm52-int8}
export GLM5_STAGE_DIR=/local/glm5_tf_$JOB_TAG GLM5_NSHARDS=${GLM5_NSHARDS:-233} GLM5_STAGE_LAYERS=78
...
echo "=== INT8 TF check NP=$NP model=$GLM5_MODEL_DIR job=${PJM_JOBID:-?} ==="; date; mkdir -p "$WORK"||exit 2; cd "$WORK"||exit 2
