#!/bin/bash
# GLM-5.2 FP8 full-layer chunked-prefill benchmark on 192 A64FX nodes
# with a 16x12 torus placement. Defaults match the stable 96-node prefill
# measurement; override GLM5_MAXPOS/GLM5_CP/GLM5_MSA for long-context tests.
...
WORK="$GLM5/prefill_fp8_run_${JOB_TAG}_192n"
...
for t in 1 2 3 4 5; do
    ...
    echo "[prefill-fp8-192] topo try $t failed; retry"
    sleep 3
done
...
echo "=== prefill-fp8-192 done $(date) ==="
