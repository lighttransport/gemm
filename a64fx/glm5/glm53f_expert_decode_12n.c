...
#pragma omp parallel for schedule(static)
    for(int i=0;i<tokens*4096;i++)c->batch_local[i]+=c->batch_shared[i];return MPI_Allreduce(c->batch_local,out,tokens*4096,MPI_FLOAT,MPI_SUM,MPI_COMM_WORLD)==MPI_SUCCESS?0:-1;}
