...
#PJM -g hp250467
#PJM -L "rscgrp=small,node=96,elapse=00:52:00"
...
NP=96; JOB_TAG=${PJM_JOBID:-manual_$$}; WORK="$GLM5/bestof1h_run_${JOB_TAG}"
GEN=${GLM5_GEN_NEW:-512}; SEED=${GLM5_SEED:-${PJM_JOBID:-12345}}
TOK_PER_S=0.20; BUDGET_S=2820; MARGIN_S=150; EST_S=$(awk -v g=$GEN -v r=$TOK_PER_S "BEGIN{printf \"%d\", g/r+150}")
