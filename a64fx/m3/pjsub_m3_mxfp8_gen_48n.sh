...
# Detokenize: python3 a64fx/m3/m3_tokenizer.py decode-file a64fx/m3/gen_mxfp8_48.txt
#
...
echo "=== M3-MXFP8 gen 48n (4x4x3): NP=$NP job=${PJM_JOBID:-?} $(date) ==="
...
echo "--- generate ($(date)) ---"
M3_REAL=1 M3_PROMPT_IDS="$M3/prompt_ids.txt" M3_GEN_OUT="$M3/gen_mxfp8_48.txt" \
...
echo "--- gen ids ---"; cat "$M3/gen_mxfp8_48.txt" 2>/dev/null
echo "=== done $(date) ==="
