...
export M3_MODEL_DIR=$HOME/models/m3 M3_NSHARDS=59 M3_STAGE_DIR=/local/m3 M3_STATUS_DIR="$RUN"
export M3_EP_SIZE=$NP M3_TP=1 M3_MSA=1 M3_MAXPOS=20480 M3_MAX_NEW=2
export LLM_THREADS=48 OMP_NUM_THREADS=48
NTOK=16384; WTAG=bf16
...
# exactly NTOK-token prompt (tile the 6-token prompt by TOKEN count; throughput test)
