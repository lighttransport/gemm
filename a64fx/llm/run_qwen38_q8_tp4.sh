...
# TP_Q8_EXPAND_NEXTN_MASK selects experimental draft components: 1=EH,
# 2=Q, 4=attention output, 8=FFN gate, 16=FFN down, 32=LM head,
# 64=FFN up, 128=K, and 256=V.
...
case "$MODE" in
    plan|stage)
        ...
        ;;
    stream|null|check|bench|mtp-check|profile)
        ...
        ;;
    *) echo "usage: TP_SIZE={2|3|4} $0 {plan|stage|stream|null|check|bench|mtp-check|profile}" >&2; exit 2 ;;
esac
